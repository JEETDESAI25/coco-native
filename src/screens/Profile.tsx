    ...
    <>
      ...
      <NWView className=" h-[83%] ">
        <ScrollView contentInsetAdjustmentBehavior="automatic">
          <NWText className=" text-l color-[#000000FF] py-1 ">
            Profile Picture
          </NWText>
          ...
          <NWText className=" text-l color-[#000000FF] py-2 ">
            Change Password
          </NWText>
          <Formik
            initialValues={
          ...
          <NWText className=" text-l color-[#000000FF] pb-2 pt-8 ">
            Controls
          </NWText>
